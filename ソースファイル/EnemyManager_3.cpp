// 敵管理クラス3(基本とほぼ同じ)(CEnemyManager_3.cpp)
...
CEnemyManager_3::CEnemyManager_3(CScene* pScene) : CEnemyManager(pScene)
{
}


HRESULT CEnemyManager_3::Init()
{
	//HRESULT hr = S_OK;
...
void CEnemyManager_3::CreateWave(int WaveNum)
{
	...
	case 3:
	{
		...
		for (int i = 0; i < m_pWave.size(); ++i) {
			...
			mtxRot = XMMatrixRotationRollPitchYaw(0.0f, (-fAngle + XMConvertToRadians(-90.0f)), 0.0f);
			mtxWorld = XMMatrixMultiply(mtxRot, mtxWorld);

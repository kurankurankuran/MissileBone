...
static /*EModel*/int g_ModelType = 0/*MODEL_SKY*/;
...
#ifdef _DEBUG
	if (GetCurCullMode() >= MAX_CULLMODE)
	{
		mtxTexture._44 = 0.0f;
		vFlags = XMUINT4(0, 0, 0, 0);
		pMaterial->Reset();
	}
#endif // !_DEBUG
...
void CAssimpModel::ScaleAsset()
{
	...
	/*}
	else if(g_ModelType == MODEL_PLAYER)
	{
		

		m_vBBox.x = PLAYER_BS_RAD / 2;
		m_vBBox.y = PLAYER_BS_RAD / 2;
		m_vBBox.z = PLAYER_BS_RAD / 2;
		m_vCenter.x = PLAYER_CENTER_X;
		m_vCenter.y = PLAYER_CENTER_Y;
		m_vCenter.z = PLAYER_CENTER_Z;
